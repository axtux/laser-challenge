...
Nous allons ici , essayer d'argumenter de la meilleure manières nos choix d'implémentations que nous avons pris lors de cette phase.
...
Nous avons également pu nous refamiliariser avec la JavaDoc, JUnit vus, quand à eux, en Bac1. 
\end{document}
